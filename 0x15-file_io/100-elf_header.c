 ...
 * Checks if the file is an ELF file by comparing the magic numbers.
 ...
 * @e_identify: A pointer to an array of magic numbers
 */
void print_magic(unsigned char *e_identify)
{
	int index;
 ...
 * @e_identify: A pointer to an array containing the ELF class.
 * Prints the data representation (little-endian or big-endian)
 */
void print_data(unsigned char *e_identify)
{
	printf(" Data: ");
...
/**
 * Prints the type (executable, relocatable, etc.) of the ELF header.
 ...
 * opens the file, reads the ELF header
 * Return: 0 on success
 */
